class Coalesce < Formula
    ...
    sha256 "841248037144e5e79bb88366c7da90427ba1d7420504893529343993e511433e" # Replace with output from: curl -L https://github.com/welcome-to-the-sunny-side/coalesce/archive/refs/tags/v0.1.0.tar.gz | shasum -a 256
    license "MIT"
